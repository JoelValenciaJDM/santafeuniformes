...
<div class="container">
	...
	<?php endif; ?>
	<div class="card p-4">
		<?php echo form_open_multipart(base_url("index.php/sscm/tela/create")); ?>
		<table class="w-100">
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" type="text" name="Metros" placeholder="Metros" required></td>
			</tr>
			<tr>
				<td class="d-md-table-cell d-none" style= "width: 200px;"><label for="Ancho">Ancho:</label></td>
				<td><input type="text" class="form-control" type="text" name="Ancho" placeholder="Ancho" required></td>
			</tr>
			<tr>
				<td class="d-md-table-cell d-none" style= "width: 200px;"><label for="Fecha_ingreso">Fecha de ingreso:</label></td>
				<td><input type="date" class="form-control" type="text" name="Fecha_ingreso" placeholder="Fecha de ingreso" required></td>
			</tr>
			<tr>
				<td class="d-md-table-cell d-none" style= "width: 200px;"><label for="Color">Colorecha de modificación:</label></td>
				<td><input type="text" class="form-control" type="text" name="Color" placeholder="Color" required></td>
			</tr>
