		...
		<tr>
			...
			<tr>
				...
				<td><select type="text" class="form-control" type="text" name="gener" required>
					...
					<option value="0" <?php if($Wear->gener == 0){ echo ('selected');}?>>Caballero</option>
					<option value="1" <?php if($Wear->gener == 1){ echo ('selected');} ?>>Dama</option>
					<option value="2" <?php if($Wear->gener == 2){ echo ('selected');} ?>>Unisex</option>
				</select></td>
			</tr>			
			<tr>
