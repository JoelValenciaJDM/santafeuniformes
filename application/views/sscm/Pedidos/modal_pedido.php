  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content ml-20" style="width:800px;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Compra a otro proveedor</h5>
...
<div class="modal" id="fabricadoTrigger" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content ml-200" style="width:800px;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Producción de prenda</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?php echo form_open_multipart(base_url("index.php/sscm/Customer/create"), 'id="modalFabrica"'); ?>
...
<!-- Modal Compra -->
<div class="modal" id="compradoTrigger" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content ml-200" style="width:800px;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Pedido para compra</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?php echo form_open_multipart(base_url("index.php/sscm/Customer/create"), 'id="modalcompra"'); ?>
        <div class="form-row align-items-center  ml-2">
          <div class="col-md-3 col-g-3 col-sm-3">
            <label>Categoría</label>
          </div>
        ...
        <input type="hidden" class="form-control mb-2" name="tipo" value="1" id="tipocompra">
        <div class="form-row align-items-center mb-2">
          <div class="col-md-3 col-g-3 col-sm-3">
            <select id="selecttipoprendacompra" type="text" class="form-control mb-2 mr-2" type="text" name="id_tipo_prenda" required>
              <option value="0">Seleccione una categoría</option>
              <?php foreach ($tipoprendas as $tipoprenda) : ?>
                <option value="<?= $tipoprenda->id_tipo_prenda ?>"><?= $tipoprenda->name ?></option>
              <?php endforeach; ?>
          ...
          <div class="col-md-3 col-g-3 col-sm-3">
            <select id="selectprendacompra" type="text" class="form-control mb-2" type="text" name="id_prenda" required>
              <option value="0">Seleccine la prenda</option>
            </select>
          </div>
          <div class="col-md-3 col-g-3 col-sm-3">
            <select id="selecttelacompra" type="text" class="form-control mb-2 mr-2" type="text" name="id_tela" required>
              <option value="0">Seleccione una tela</option>
              <?php foreach ($tipotelas as $tipotela) : ?>
                <option value="<?= $tipotela->id_tela ?>"><?= $tipotela->Nombre ?></option>
              <?php endforeach; ?>
        ...
        <div class="form-row align-items-center mb-2">
          <div class="col-md-3 col-g-3 col-sm-3">
            <select id="selectcolortelacompra" type="text" class="form-control mb-2" type="text" name="id_tipo_prenda" required>
              <option value="0">Color</option>
              <?php foreach ($colors as $color) : ?>
                <option value="<?= $color->id_color ?>"><?= $color->name ?></option>
              <?php endforeach; ?>
          ...
          <div class="col-md-3 col-g-3 col-sm-3 ml-3">
            <select id="selecttonotelacompra" type="text" class="form-control mb-2" type="text" name="id_tipo_prenda" required>
              <option value="0" id="id_colorcompra">Tono</option>
            </select>
          </div>
          <div class="col-md-1 col-g-1 col-sm-1">
            <input type="checkbox" id="bordadocompra" value="1"> <label for=" bordado  ">bordado</label>
          </div>
          <div class="col-md-1 col-g-1 col-sm-1">
            <input type="checkbox" id="cerigrafiacompra" value="1"> <label for=" cerigrafia">cerigrafia</label>
          </div>
        </div>
        <hr>
        <h4>Tallas y cantidad</h4>
        <div class="form-row align-items-center mb-2" id="tallacompra">
          <div class="col-md-3 col-g-3 col-sm-3">
            <label>Talla</label>
          </div>
          <div class="col-md-3 col-g-3 col-sm-3">
          ...
          <div class="col-md-3 col-g-3 col-sm-3">
            <button type="button" class="btn btn-secondary mb-2" id="newTallacompra">Agregar otra talla</button>
          </div>
          <div class="col-md-3 col-g-3 col-sm-3">
            <button type="button" class="btn btn-danger mb-2" id="deleteTallacompra">Eliminar talla</button>
          </div>
        </div>
        <input type="hidden" class="form-control mb-2" name="cantidad" value="1" id="cantidad_tallascompra">
        <div class="form-row align-items-center mb-2 " id="idcompra">
          <div class="col-md-3 col-g-3 col-sm-3">
            <select id="selecttallascompra" type="text" class="form-control mb-2 selecttallas" type="text" name="id_tipo_prendacompra" required>
              <option value="0">Talla</option>
            </select>
          </div>
          <div class="col-md-3 col-g-3 col-sm-3">
            <input type="number" class="form-control mb-2 cantidad_prendas" name="cantidad" min="1" id="cantidad_prendascompra">
          </div>
        </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button id="savePrendaDataCompra" class="btn btn-primary" name="submit">Enviar</button>
      </div>
    </div>
  </div>
</div>