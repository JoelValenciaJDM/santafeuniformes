...
<body>	
	<div class="container">
		...
		<?php echo form_open_multipart(base_url("index.php/ajax/sendDataPedido")); ?>
		<div>
			<!--no visible data-->
		...
		<div class="form-row align-items-center mb-2">
			...
			<div class="col-md-5 col-g-5 col-sm-5">
				...
				<input type="hidden" class="form-control mb-2" id="id_customer">
			</div>
			<div class="col-md-1 col-g-1 col-sm-1">
		...
		<div class="form-row align-items-center mb-2">
			...
			<div class="col-md-5 col-g-5 col-sm-5">
				<select type="text" class="form-control mb-2" type="text" id="id_vendedor" name="id_vendedor" required>
	...
	<button class="btn btn-success" id="submitData"><i class="fa fa-save"></i> Crear</button>
	</div>
</div>
